...
drop_columns <- which(apply(employeeDatRaw, 2, zeroVariation))
...
employeeDatRaw[,factor_columns] <- sapply(factor_columns,function(x) as.numeric(employeeDatRaw[[x]]))
```

##### Dropped columns: `r cols`
##### Factor columns: `r factor_columns`
